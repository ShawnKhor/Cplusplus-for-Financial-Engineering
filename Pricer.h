...
class Pricer {
public:
  virtual double Price(Market& mkt, Trade* trade);

private:
  virtual double PriceTree(Market& mkt, const TreeProduct& trade) { return 0; };
};
...
public:
  ...
  double PriceTree(Market& mkt, const TreeProduct& trade) override;
